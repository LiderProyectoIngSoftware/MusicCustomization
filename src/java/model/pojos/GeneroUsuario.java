...
/**
 * GeneroUsuario generated by hbm2java
 */
public class GeneroUsuario  implements java.io.Serializable {
    ...
    public GeneroUsuario(int idUsuario, Usuario usuario) {
        this.idUsuario = idUsuario;
        this.usuario = usuario;
    }
    public GeneroUsuario(int idUsuario, Usuario usuario, Double rock, Double pop, Double reggae, Double reggaeton, Double merengue, Double salsa, Double cumbia, Double clasica, Double jazz, Double metal, Double samba, Double disco) {
       this.idUsuario = idUsuario;
       this.usuario = usuario;
       this.rock = rock;
       this.pop = pop;
